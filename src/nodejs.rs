    ...
    Ok(TranscriptionConfig {
        ...
        decoder: DecoderConfig {
            ...
            language_model: options.lm.map(|path| LmConfig {
                ...
                hot_words: options.hot_words.unwrap_or_default(),
                hot_word_bonus: options.hot_word_bonus.unwrap_or(0.0) as f32,
...
fn candidate_to_node(candidate: &ScoredCandidate) -> ScoredCandidateObject {
    ScoredCandidateObject {
        ...
        hot_word_score: candidate.hot_word_score as f64,
